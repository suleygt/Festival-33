...
const filteredGroups = festivalData
.filter(group => group.date === date)
.sort((a, b) => a.importance - b.importance);

// Class isimlerini belirlemek için yardımcı fonksiyon
...
<div className='lineup-container'>
  ...
  {filteredGroups.map((group, index) => (
    <p key={index} className={`poster-group ${getClassByImportance(group.importance)}`}>
      {group.name}
    </p>
  ))}
